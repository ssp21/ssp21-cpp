...
{				
	...
	public:
		...
		virtual void hash_sha256(std::initializer_list<openpal::RSlice> data, SymmetricKey& output) = 0;

		virtual void hmac_sha256(const openpal::RSlice& key, std::initializer_list<openpal::RSlice> data, SymmetricKey& output) = 0;
