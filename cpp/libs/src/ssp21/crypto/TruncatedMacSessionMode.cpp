...
namespace ssp21
{
    ...
    ) const
    {
        ...
        mac_func(key.as_slice(), { ad_bytes, user_data_length_bytes, msg.user_data.seq.widen() }, calc_mac_buffer);
    ...
    ) const
    {
        ...
        mac_func(key.as_slice(), { ad_bytes, user_data_length_bytes, user_data.widen() }, auth_tag);
