...
{	
	...
	public:
		...
		static auth_handshake_t default_auth_handshake() { return &auth_handshake_hmac_sha256; }

		static calc_handshake_mac_t default_calc_handshake_mac() { return &calc_handshake_hmac_sha256; }
	...
	private:		
		...
		inline static uint8_t get_calc_byte(EntityId id) { return (id == EntityId::Initiator) ? 0x01 : 0x02; }

		inline static uint8_t get_auth_byte(EntityId id) { return (id == EntityId::Responder) ? 0x01 : 0x02; }
