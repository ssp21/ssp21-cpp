...
namespace ssp21
{
    ...
    bool HandshakeAuthentication::auth_handshake_with_mac(mac_func_t mac_func, const SymmetricKey& key, EntityType id, const seq8_t& mac_value)
    {
    ...
    void HandshakeAuthentication::calc_handshake_mac_with_macfunc(mac_func_t mac_func, const SymmetricKey& key, EntityType id, HashOutput& output)
    {
